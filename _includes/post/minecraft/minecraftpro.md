...
AcademyCraft是Minecraft的一个关于超能力的模组，包括获取，升级和使用。该mod的灵感来自
“某种科学轨道[炮”，](https://en.wikipedia.org/wiki/A_Certain_Scientific_Railgun)但该mod的内容不受背景的限制。在ACMod中，您可以体验
在原始系列中已经出现（或尚未出现）的许多超能力，并且通过使用能力变得越来越强大。
ACMod将完全覆盖您在Minecraft中的游戏过程。您可以使用各种技能来加快收割，移动和战斗的效率……

在ACMod中，您必须使用块Ability Developer来学习和获取能力类别。Ability Developer消耗了
名为Imag Flux 的神秘能量，因此您需要构建一套能量系统以支持能力开发以及许多其他项目
和材料的设计。但是，您将永远摆脱连接和设置电线的负担！您可以使用无线能量系统
在能量块之间建立连接！

ACMod还很年轻，并且正在积极开发中，我们正在尝试添加更多内容和机制。目前，ACMod已实现：

- 4个类别：Electromaster，Meltdowner，Teleporter，矢量操纵
- 30多种独特技能
- 完整的成就系统
- 丰富的跨mod /跨插件支持（EU / RF能量，NEI，Residence插件）
- 服务器友好（允许关闭PvP并阻止破坏和填充）
- 使用Ripple脚本自定义技能数据
- 还有更多……。

[![新闻14](http://ac.li-dev.cn/wp-content/uploads/2016/05/news14-1024x542.jpg)](http://ac.li-dev.cn/wp-content/uploads/2016/05/news14.jpg) [![等离子大炮](http://ac.li-dev.cn/wp-content/uploads/2016/05/plasma_cannon-1-1024x645.jpg)](http://ac.li-dev.cn/wp-content/uploads/2016/05/plasma_cannon-1.jpg) [![电磁炮](http://ac.li-dev.cn/wp-content/uploads/2016/05/%E7%94%B5%E7%A3%81%E7%82%AE-1024x541.jpg)](http://ac.li-dev.cn/wp-content/uploads/2016/05/电磁炮.jpg) [![新闻6](http://ac.li-dev.cn/wp-content/uploads/2016/05/news6-1024x576.jpg)](http://ac.li-dev.cn/wp-content/uploads/2016/05/news6.jpg) [![新闻2](http://ac.li-dev.cn/wp-content/uploads/2016/05/news2-1024x542.jpg)](http://ac.li-dev.cn/wp-content/uploads/2016/05/news2.jpg)
...
- 印刀以上（不论有没有断裂），Proudsoul>=1000；
- 攻击时刀必须出鞘；
- 在满足条件二的前提下击杀至少一个生物；
- 在满足条件三的前提下收刀（必须要是有收刀动画的收刀，直接回去的将会视为连击中断而无效）；
- 在出鞘到收刀时没有收到伤害（摔落伤害除外）；

在满足以上五个条件后，你的身边会出现蓝色粒子效果并且回复大量耐久（杀的生物越多回的越多，几乎远大于你达成以上五个条件所消耗的耐久）

事实上，比如超sa和大多数sa只要不在中途收到伤害都可以完成以上条件，所以超sa和耐久以及刷怪塔完全可以做到发动超sa->消耗耐久->杀死怪物->回满耐久->发动超sa的循环，以达到高效刷怪。



#### 刀法四手及进阶

福利福利，开坑第一篇教程，讲讲招数（小声：玩了这么久，原来有招数）其实就是发发剑气啥的啦。。（手速快可以定住小黑，延迟苦力怕爆炸）不说废话了，直接放了

第一手

第一刀左键：第一刀上切，敌人浮空并被拘束（无法动弹）
  第二刀左键下切，单体攻击，把敌人打下来，并强制给敌人造成掉落伤害，对方无法攻击
    第二到右键下切，范围攻击，并把敌人从空中打下来，强制给敌人造成掉落伤害
...
第一刀右键：空中居合斩，范围，拘束敌人，对方无法攻击
     第二刀右键：拔刀，范围攻击，有击退II以上效果
     第二刀左键：抜刀，单体攻击，有击退II以上的效果，对方无法攻击

第四手（空中）

第一刀左键：空中居合斩，单体攻击，拘束敌人
     第二刀右键：拔刀，范围攻击，有击退II以上效果
     第二刀左键：抜刀，单体攻击，有击退II以上的效果，对方无法攻击

少侠感觉回家练剑吧，欲练神功，必先。。哎呀，跑题了，反正



随着版本跟新，拔刀剑的招式也越加华丽了，以下为r87版本下战斗时快捷键总结，欢迎各路大神补充完善。

1. 关于右键

2. 1. 锁定+前进+右键 向前突进，并发动旋风斩，对周身敌人造成群体攻击，若长按右键可继续触发连招；
   2. 锁定+后退+右键 出鞘斩，使敌人浮空并造成硬直，若长按右键自身也会高高跃起并在空中触发连招；

3. 关于默认v键

4. 1. 前进/后退/左移/右移+v键均会触发[闪避](https://www.mcmod.cn/item/51350.html)，可向对应方向进行一次短距离高速移动；
   2. 当手持的拔刀剑有力量附魔时，锁定+前进+v，可向锁定目标发射一枚幻影剑并瞬移至锁定目标前方（请对爬行者慎用……）
